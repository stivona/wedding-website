      ...
      <div className="container-wedding">
        ...
        <div className="max-w-3xl mx-auto mt-16">
          <div className="card border-2 border-olive/30 bg-olive/5">
            ...
            <div className="w-full overflow-hidden rounded-lg" style={{ minHeight: '500px' }}>
              <a
                data-pin-do="embedBoard"
                data-pin-board-width="900"
                data-pin-scale-height="600"
                data-pin-scale-width="115"
                href="https://www.pinterest.com/stivona/wedding-dress-code/"
                className="w-full"
              />
            </div>
            
            <p className="font-body text-olive/50 text-xs mt-4 text-center">
              <a 
                href="https://pin.it/16tt2LdRa" 
                target="_blank" 
                rel="noopener noreferrer"
                className="hover:text-olive transition-colors underline"
              >
